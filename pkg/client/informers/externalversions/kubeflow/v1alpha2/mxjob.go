...
import (
	...
	mxnet_v1alpha2 "github.com/kubeflow/mxnet-operator.v2/pkg/apis/mxnet/v1alpha2"
	versioned "github.com/kubeflow/mxnet-operator.v2/pkg/client/clientset/versioned"
	internalinterfaces "github.com/kubeflow/mxnet-operator.v2/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha2 "github.com/kubeflow/mxnet-operator.v2/pkg/client/listers/kubeflow/v1alpha2"
...
func (f *mXJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mxnet_v1alpha2.MXJob{}, defaultMXJobInformer)
}
